---
title: "Portia's Couture"
publishedAt: "2024-04-01"
summary: Developing a Premium fashion e-commerce experience
images:
  - "/images/projects/project-01/portiarev.png"
  - "/images/projects/project-01/portias.png"
team:
  - name: "Dennis Maina"
...
- **Personalized styling recommendations**: Developed a custom Figma plugin that extracts design tokens such as colors, typography, and spacing values, and exports them in a format compatible with our codebase.
- **Virtual try-on for select garments**: Integrated an automated process that translates Figma components into React code using a combination of design tokens and pre-built component templates. This allowed developers to focus more on logic and less on repetitive UI coding.
...
- **Appointment booking**: Seamless appointment booking for fittings
- **Personalization**: Personalized styling recommendations
## Technologies Used
