...
const home: Home = {
  ...
  subline: (
    <>
      I'm Maina, a Web Developer based in Nairobi, Kenya. <br /> I turn ideas into engaging digital experiences.
...
const about: About = {
  ...
  intro: {
    ...
    description: (
      <>
        Maina is a web developer and network technician who’s passionate about crafting digital solutions and building connections that matter. 
              ...
              Ready to launch something extraordinary together? 
        Let's connect and create the future of the web, one pixel at a time.
      </>
    ),
  },
  work: {
    ...
    institutions: [
      {
        ...
        description: <>Studied Bsc in Information Technology.</>,
      },
      {
